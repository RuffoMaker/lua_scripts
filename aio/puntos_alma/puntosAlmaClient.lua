...
local buttonAddSoulPoints = createButton(frameAttributes, "Comprar un punto", 150, 30, 0, 50, "BOTTOM")
local buttonResetSoulPoints = createButton(frameAttributes, "Reiniciar puntos", 150, 30, 0, 30, "BOTTOM")
