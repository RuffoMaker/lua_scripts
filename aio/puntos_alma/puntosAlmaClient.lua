...
fontAttributesStrength:SetPoint("TOPLEFT", -20, -75)
...
fontAttributesStrengthValue:SetPoint("TOPLEFT", 107, -75)
...
buttonAttributesIncreaseStrength:SetPoint("TOPLEFT", 144, -69)
...
fontAttributesAgility:SetPoint("TOPLEFT", -20, -95)
...
fontAttributesAgilityValue:SetPoint("TOPLEFT", 107, -95)
...
buttonAttributesIncreaseAgility:SetPoint("TOPLEFT", 144, -89)
...
fontAttributesStamina:SetPoint("TOPLEFT", -20, -115)
...
fontAttributesStaminaValue:SetPoint("TOPLEFT", 107, -115)
...
buttonAttributesIncreaseStamina:SetPoint("TOPLEFT", 144, -109)
...
fontAttributesIntellect:SetPoint("TOPLEFT", -20, -135)
...
fontAttributesIntellectValue:SetPoint("TOPLEFT", 107, -135)
...
buttonAttributesIncreaseIntellect:SetPoint("TOPLEFT", 144, -129)
...
fontAttributesSpirit:SetPoint("TOPLEFT", -20, -155)
...
fontAttributesSpiritValue:SetPoint("TOPLEFT", 107, -155)
...
buttonAttributesIncreaseSpirit:SetPoint("TOPLEFT", 144, -149)
...
buttonAddSoulPoints:SetSize(20, 20)
buttonAddSoulPoints:SetPoint("TOPLEFT", 144, -189)
buttonAddSoulPoints:EnableMouse(true)
buttonAddSoulPoints:SetNormalTexture("Interface\\Buttons\\CancelButton-Up")
buttonAddSoulPoints:SetPushedTexture("Interface\\Buttons\\CancelButton-Down")
buttonAddSoulPoints:SetHighlightTexture("Interface\\Buttons\\CancelButton-Highlight")
