...
--Arcemu Global constants used in Lua functions. Feel free to use these
--Rather than messy Hex values or hard to remember numbers.
--Author: Hypersniper
...
--Factions
    ...
    FACTION_TIMBERMAW_HOLD = 35
    FACTION_CENARION_CIRCLE = 36
    FACTION_THRALLMAR = 37
    FACTION_HONOR_HOLD = 38
    FACTION_THE_SHA_TAR = 39
    ...
    FACTION_ALLIANCE_FORCES = 47
    FACTION_HORDE_FORCES = 48
    FACTION_EXODAR = 49
    FACTION_DARKMOON_FAIRE = 50
    FACTION_ZANDALAR_TRIBE = 51
    FACTION_THE_DEFILERS = 52
    FACTION_THE_LEAGUE_OF_ARATHOR = 53
    FACTION_BROOD_OF_NOZDORMU = 54
    FACTION_SILVERMOON_CITY = 55
    FACTION_TRANQUILLIEN = 56
    FACTION_THE_SCALE_OF_THE_SANDS = 57
    FACTION_THE_ALDOR = 58
    FACTION_SHATTRATH_CITY = 59
    FACTION_THE_CONSORTIUM = 60
    FACTION_THE_MAG_HAR = 61
    FACTION_THE_SCRYERS = 62
    FACTION_THE_VIOLET_EYE = 63
    FACTION_CENARION_EXPEDITION = 64
    FACTION_SPOREGGAR = 65
    FACTION_KURENAI = 66
    FACTION_KEEPERS_OF_TIME = 67
    FACTION_FRIENDLY_HIDDEN = 68
    FACTION_LOWER_CITY = 69
    FACTION_ASHTONGUE_DEATHSWORN = 70
    FACTION_NETHERWING = 71
    FACTION_SHATARI_SKYGUARD = 72
    FACTION_OGRI_LA = 73
...
--INVIS_FLAG
    ...
    INVIS_FLAG_NORMAL = 0 -- players and units with no special invisibility flags
...
UNIT_VIRTUAL_ITEM_SLOT_ID_1 =              OBJECT_END + 0x0032   -- Size:3  Type:Int32  Flags:1
UNIT_VIRTUAL_ITEM_SLOT_ID_2 =              OBJECT_END + 0x0033   -- Size:3  Type:Int32  Flags:1
